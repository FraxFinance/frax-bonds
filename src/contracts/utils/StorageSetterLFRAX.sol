...
contract StorageSetterLFRAX {
    ...
    function setNameAndSymbol() public {
        // Name
        Storage.setBytes32(bytes32(uint256(3)), bytes32("Legacy Frax Dollar") | bytes32(uint256(36)));

        // Symbol
        Storage.setBytes32(bytes32(uint256(4)), bytes32("LFRAX") | bytes32(uint256(10)));
    }
